...
const users_data_controller_1 = require("../controllers/users.data.controller");
...
exports.default = (app) => {
    app.route('/api/users/me')
        .get(passport_1.default.authenticate('jwt'), policy.isAllowed, users_controller_1.default.me);
    ...
    app.route('/api/users').all(passport_1.default.authenticate('jwt'), policy.isAllowed)
        .put(model.isValid(user_schema_1.default.User), users_controller_1.default.update)
    ...
    app.route('/api/users/data').all(passport_1.default.authenticate('jwt'), policy.isAllowed)
        .get(users_data_controller_1.get)
        .delete(users_data_controller_1.deleteUser);
    app.route('/api/users/data/mail').all(passport_1.default.authenticate('jwt'), policy.isAllowed)
        .get(users_data_controller_1.getMail);
};
