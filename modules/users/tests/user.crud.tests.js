   ...
   */
    describe('Logged', () => {
        beforeEach(async () => {
            ...
            userInfoEdited = lodash_1.default.clone(userInfo);
            userInfoEdited.email = credentials[1].email;
            userInfoEdited.password = credentials[1].password;
            // add user
            try {
...
//# sourceMappingURL=user.crud.tests.js.map