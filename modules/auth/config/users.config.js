...
exports.default = (app) => {
    ...
    config_1.default.utils.getGlobbedPaths(path_1.default.join(__dirname, './strategies/**/*.js')).forEach((strategy) => {
        require(path_1.default.resolve(strategy)).default(config_1.default);
    });
