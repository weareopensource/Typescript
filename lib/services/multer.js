...
exports.generateFileName = exports.create = exports.storage = void 0;
...
const fileFilter = (formats) => (req, file, callback) => {
    if (formats.includes(file.mimetype))
        ...
        callback(new AppError_1.default(`Only ${formats} images allowed`, { code: 'SERVICE_ERROR' }), false);
};
/**
 * set Strorage
 */
module.exports.storage = () => {
    exports.storage = mongoose_gridfs_1.createBucket({
        bucketName: 'uploads',
        model: 'Uploads',
    });
};
...
function create(name, config) {
    return async (req, res, next) => {
        ...
        // set storage
        options.storage = exports.storage;
        // upload
...
function generateFileName(filename) {
    return new Promise((resolve, reject) => {
        crypto_1.default.randomBytes(32, (err, buf) => {
            if (err)
                reject(new AppError_1.default('Error generateFileName', { code: 'SERVICE_ERROR' }));
