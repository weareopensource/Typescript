...
function initModulesConfiguration(app) {
    try {
        config_1.default.files.configs.forEach((configPath) => {
            require(path_1.default.resolve(configPath)).default(app);
        });
    }
    catch (e) {
        console.log(e.stack);
...
function initModulesServerPolicies() {
    try {
        config_1.default.files.policies.forEach(async (policyPath) => {
            require(path_1.default.resolve(policyPath)).default();
        });
    }
    catch (e) {
        console.log(e.stack);
...
function initModulesServerRoutes(app) {
    try {
        config_1.default.files.routes.forEach((routePath) => {
            require(path_1.default.resolve(routePath)).default(app);
        });
    }
    catch (e) {
        console.log(e.stack);
