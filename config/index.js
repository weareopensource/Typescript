 ...
 */
const initGlobalConfigFiles = (config, assetsConfig) => {
...
const initGlobalConfig = () => {
    ...
    // Merge config files
    const config = lodash_1.default.merge(defaultConfig.default, environmentConfigVars);
    // read package.json for MEAN.JS project information
    // config.package = require(path.resolve('./../../package.json'));
    // Initialize global globbed files
    initGlobalConfigFiles(config, assets_1.default);
